...
parser.add_argument("-pred", "--prediction", type=str, default="/exports/eddie/scratch/s2062378/dataset/VMD/faces_results")
parser.add_argument("-exp", "--exp", type=str, default="VMD_ours")
parser.add_argument("-gt", "--mirrormask", type=str, default=os.path.join("/exports/eddie/scratch/s2062378/dataset/VMD", "faces"))
