...
#$ -wd /home/s2062378/VMD-Net-SemiSup/
...
# Train the model
python3 /home/s2062378/VMD-Net-SemiSup/code/train.py

# Run the test set through the model
python3 /home/s2062378/VMD-Net-SemiSup/code/infer.py

# Evaluate the model on the test set
python3 /home/s2062378/VMD-Net-SemiSup/code/eval.py

# Infer and run on Pexels annotated images

# Run the test set through the model
python3 /home/s2062378/VMD-Net-SemiSup/code/infer_pexels.py

# Evaluate the model on the test set
python3 /home/s2062378/VMD-Net-SemiSup/code/eval_pexels.py