...
from config import VMD_pexels_root
...
def main():
    ...
    checkpoint = '/home/s2062378/VMD-Net_Original/model/best_mae.pth'
        ...
        for video in tqdm(video_list):
            ...
            for exemplar_idx, exemplar_name in enumerate(img_list):
                ...
                for query_idx in query_idx_list:
                    ...
                    check_mkdir(os.path.join("results-pexels", video))
                    save_name = f"{exemplar_name}.png"
                    Image.fromarray(prediction).save(os.path.join("results-pexels", video, save_name))
