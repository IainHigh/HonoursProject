...
# Train the model
python3 /home/s2062378/VMD-Net-EM/code/train.py

# Run the test set through the model
python3 /home/s2062378/VMD-Net-EM/code/infer.py

# Evaluate the model on the test set
python3 /home/s2062378/VMD-Net-EM/code/eval.py

# Infer and run on Pexels annotated images

# Run the test set through the model
python3 /home/s2062378/VMD-Net-EM/code/infer_pexels.py

# Evaluate the model on the test set
python3 /home/s2062378/VMD-Net-EM/code/eval_pexels.py