...
from config import ViSha_training_root, ViSha_validation_root
...
val_set = CrossPairwiseImg([ViSha_validation_root], val_joint_transform, img_transform, target_transform)
