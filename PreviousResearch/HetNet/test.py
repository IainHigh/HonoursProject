...
class Test(object):
    def __init__(self, Dataset, Network, path):
        ...
        self.cfg = Dataset.Config(
            dataset="PMD",
            datapath=path,
            snapshot="/home/iain/Desktop/HonoursProject/PreviousResearch/HetNet/PMD-model-best/model-best",
            mode="test",
        )
...
if __name__ == "__main__":
    for path in [
        "/home/iain/Desktop/HonoursProject/Datasets/PMD_benchmark_combined/mine"
    ]:
